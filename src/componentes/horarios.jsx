      ...
      {loading ? (
        ...
        <div className="flex flex-col text-sm leading-4 gap-4 ">
          <div className=" border-slate-200 rounded-sm flex flex-col gap-1 p-1">
            ...
            <ul className="w-full bg-slate-100 flex flex-row gap-2 rounded-md items-center   text-slate-500">
              {days.map((p, i) =>
                i === day ? (
                  <li className="bg-purple-800 p-1 rounded-full w-full text-center text-white font-medium ">
                    {p}
                  </li>
                ) : (
                  <li
                    className="p-1  rounded-full w-full text-center cursor-pointer border border-slate-200 hover:border-purple-800 hover:text-purple-800 "
                    onClick={() => {
                      setDay(i)
                    }}
                  >
                ...
                <div className='text-blue-900 flex flex-col'>
                  ...
                  <div className="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-2 rounded-sm max-h-full overflow-y-auto">
                    {quadro_horarios.filter(o => o < "12:00").map(
                      hor => 
                      <h3
                        className="text-center bg-blue-100 border  border-blue-300
                        gap-2 py-2 text-sm rounded-md "
                      >
                        {hor}
                      </h3>
                    )}
