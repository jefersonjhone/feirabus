...
export const Relogio = ({ className }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export const QuadroHorarios = ({ className }) => {
  return (
    <svg
      width="24"
      height="24"
...
export const PinoLocalizacao = ({ className }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export const Estrela = ({ className }) => {
  return (
    <svg
      width="24"
      height="24"
...
export const RotaComBandeira = ({ className }) => {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        ></path>
        <circle fill="currentColor" cx="5.3" cy="5.32" r="0.95"></circle>
        <path
          fill="none"
          stroke="currentColor"
          strokeWidth={2}
...
export const Compartilhar = ({ className }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      x="0px"
