    ...
    <>
      ...
      <div className="h-screen">
        ...
        <main className="h-full relative md:h-3/5 bg-gradient-to-r from-sky-300 to-indigo-500 overflow-hidden">
          ...
          <div className="flex h-full relative flex-col items-center gap-4 p-2 max-w-[1200px] mx-auto overflow-hidden z-20">
            ...
            <h2 className="text-gray-200 text-center text-lg font-medium">
            ...
            <div className="flex flex-row gap-4 flex-wrap justify-center">
              <div className="flex flex-row items-center gap-2 py-2 px-4 border border-white rounded-md font-medium text-white bg-white/10 hover:bg-white-20 hover:text-slate-900">
